    ...
    <div class="row">
      ...
      <div class="col-6 col-md-3 col-lg-2 offset-lg-4">
        <ul class="list-unstyled text-md-right">
          ...
          <li><a class="py-1 d-block text-decoration-none hover-text-black" href="/blog">Blog</a></li>
      ...
      <div class="col-6 col-md-3 col-lg-2">
        <ul class="list-unstyled text-md-right">
          ...
          <li><a href="https://github.com/kettanaito" target="_blank" rel="noreferrer" class="py-1 d-block text-decoration-none hover-text-black">GitHub</a></li>
          <li><a href="https://www.youtube.com/@kettanaito" target="_blank" rel="noreferrer" class="py-1 d-block text-decoration-none hover-text-black">YouTube</a></li>
        </ul>
      </div>
    </div>
  </div>
